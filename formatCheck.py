...
# conn = mysql.connect(host="192.168.60.252",port ="3306",user="root",passwd="root",db="appcrawlerdb1")

conn = mysql.connect(host="192.168.220.171", port="3306", user="tag_admin", passwd="tag_admin$$$", db="analysys_multipolygon")
cursor = conn.cursor()
#sql1 = "select id,name,shape from re_gould_geographic_info_copy"
#sql1 = "select id,name,shape from gould_geographic_info_20190211_copy "
